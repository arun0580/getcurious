...
export const FrameWrapper = () => {
  return (
    <div className="relative max-w-7xl mx-auto px-4 py-20 flex flex-col lg:flex-row items-center lg:items-start gap-8 my-10">
      {/* Left Image */}
      <img
      ...
      <div className="flex flex-col gap-10 max-w-full lg:max-w-2xl">
        ...
        <Button
          className="!bg-orange-500 self-start"
          property1="default"
